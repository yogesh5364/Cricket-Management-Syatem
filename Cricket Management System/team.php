...
<body>
    ...
    <div class="account">
        <form action="team.php" method="post">
            <center>
                <p style="font-size: 26px; padding: 20px; color: white;" >Teams</p>
            </center>
            ...
            <?php
                ...
                $q1="SELECT * FROM team ORDER BY teamid ASC";
                ...
                <tr>
                        ...
                        <th><br> Name &nbsp; <br><br></th>
                        <th><br> &nbsp; Captain &nbsp; &nbsp; <br><br></th> 
                        <th><br> Head Coach &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<br><br></th>
                </tr>";
                while($row = mysqli_fetch_array($result1))
                {
                    ...
                    echo "<td <br> <br> &nbsp; &nbsp;" . $row['captain'] . "&nbsp; &nbsp; <br> &nbsp;";
                    echo "<td <br> <br> &nbsp; &nbsp; &nbsp;" . $row['headcoach'] . "&nbsp; &nbsp; <br> &nbsp; ";
                    echo "</tr>";
                }
                echo "</table>";
            ?>
